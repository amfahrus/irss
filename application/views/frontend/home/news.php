        ...
        <div class="col-md-8">
		  ...
		  <div class="panel panel-default">
			  <div class="panel-heading">
                   <p><h4 class="head-text"><b><?php echo $total; ?></b> <?php echo lang('news'); ?></h4></p>
              </div>
		  ...
		  ?>
		  <tr>
			<td><a href="<?php echo base_url().'home/news_detail/'.$row['news_id'].'/'.url_title($row['news_name']); ?>"><img src="<?php echo $row['company_logo']; ?>" width="50px" height="50px"></a></td>
			<td><a href="<?php echo base_url().'home/news_detail/'.$row['news_id'].'/'.url_title($row['news_name']); ?>"><b><?php echo $row['news_name']; ?></b></a><br><p class="smooth"><?php echo $row['company_name']; ?></p></td>
			<td><span class="label label-info"><?php echo $this->dokumen_lib->simple2($row['news_post_date']); ?></span></td>
		  </tr>	
			<?php } ?>
		  </tbody>
		  </table>
