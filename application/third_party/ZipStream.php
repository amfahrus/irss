...
class ZipStream {
	...
	public function openStream($filePath, $timestamp = 0, $fileComment = null)   {
		...
		//$this->streamFile = tempnam('/tmp', 'ZipStream');
		$this->streamFile = tempnam('/www/rekrutmen/tmp/', 'ZipStream');
		$this->streamData = gzopen64($this->streamFile, "w9");
		//$this->streamData = fopen('compress.zlib://' . $this->streamFile, "wb");
