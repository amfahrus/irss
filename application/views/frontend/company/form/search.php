...
$(document).ready(function() {
    ...
    var tbl_appl = $('#tbl_appl').dataTable
			({
	...
	$('#tbl_appl_filter input').attr("placeholder", "search name or email");
				
	$('#tbl_appl').on('click', 'tr', function(event) {
		$('#tbl_appl tr').css('background', '#fff');
		var id = tbl_appl.fnGetData(this)[0];
		  ...
		  <div class="col-md-12">
			  ...
			  <div class="panel panel-default">
				<div class="panel-heading">
					<a data-toggle="collapse" data-parent="#right" href="#appl">
					  <h4 class="panel-title">
						  <?php echo lang('applicants'); ?>
					  </h4>
					</a>
				</div>
				<div id="appl" class="panel-collapse collapse in">
				  
						  <div class="panel-body">
							<table class="table table-bordered table-responsive" id="tbl_appl" border="0" cellpadding="0" cellspacing="0" width="100%">
								<thead>
									<tr>
										<th>User Id</th>
										<th>Job Id</th>
