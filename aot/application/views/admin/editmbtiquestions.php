...
<div class="mainholder">
	...
	<?php 
	    ...
	    <td><div class="input">
	    	...
	    	<option value="E" <?php echo $option['option_type'] == 'E' ? 'selected' : ''; ?>> Extraversion</option>
	    	<option value="I" <?php echo $option['option_type'] == 'I' ? 'selected' : ''; ?>> Introversion</option>
	    	<option value="S" <?php echo $option['option_type'] == 'S' ? 'selected' : ''; ?>> Sensing</option>
	    	<option value="N" <?php echo $option['option_type'] == 'N' ? 'selected' : ''; ?>> iNtuition</option>
	    	<option value="T" <?php echo $option['option_type'] == 'T' ? 'selected' : ''; ?>> Thinking</option>
	    	<option value="F" <?php echo $option['option_type'] == 'F' ? 'selected' : ''; ?>> Feeling</option>
	    	<option value="J" <?php echo $option['option_type'] == 'J' ? 'selected' : ''; ?>> Judging</option>
	    	<option value="P" <?php echo $option['option_type'] == 'P' ? 'selected' : ''; ?>> Perceiving</option>
	    	</select>
	    </div>
		...
		<td><button type="button" id="btnDel" name="btnDel">remove option</button></td>
	 	...
	 	<tr>
	 	<td>&nbsp;</td>
	 	<td><input type="submit" value="Save Question" name="editmbtiquestionbttn" class="input-button ui-corner-all ui-state-default"></td>
	    </tr>
	    </tbody></table>
	    </form>
	</div>
