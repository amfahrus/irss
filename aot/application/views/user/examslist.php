<div class="mainholder ">
	<h1 style="color:#06F;">Search Exams</h1>
		...
		<li>
    			<div class="examimg" ><img src="<?=base_url();?>assets/images/exam_thumb.jpg"></div>
    			<div class="examname" >Tes Karakter</div> 
				<div class="examtake" >
					<a class="ui-corner-all ui-state-active bttn-takeexam" href="<?php echo base_url().'users/takedisc'; ?>">Take Exam</a>
				</div>
    	</li>
    	
    	<li>
    			<div class="examimg" ><img src="<?=base_url();?>assets/images/exam_thumb.jpg"></div>
    			<div class="examname" >MBTI</div> 
				<div class="examtake" >
					<a class="ui-corner-all ui-state-active bttn-takeexam" href="<?php echo base_url().'users/takembti'; ?>">Take Exam</a>
				</div>
    	</li>-->
		</ul>
        </div>
