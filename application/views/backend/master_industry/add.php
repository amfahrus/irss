						...
						<form class="form-horizontal" action="<?php echo base_url() . $act; ?>" accept-charset="utf-8" enctype="multipart/form-data" method='post'>
							<fieldset>
								<div class="control-group">
									<label class="control-label" for="focusedInput">Industry Name</label>
									<div class="controls">
									  <input class="input-xlarge focused" name='industry_name' id="focusedInput" type="text" value="<?php echo set_value('industry_name', isset($data['industry_name']) ? $data['industry_name'] : ''); ?>">
									</div>
								</div>
