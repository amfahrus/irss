...
class User_model extends CI_Model 
{
        ...
        function exam_results($examid, $userid)
        {
            ...
            $this->db->group_by(array("userexam.userid", "userexam.examid", "userexam.starttime", "userexam.endtime", "userexam.correctlyanswered", "userexam.status", "exams.examname", "exams.passmark")); 
            $exam_records = $this->db->get();
