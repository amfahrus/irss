<?php
			if($person){
		?>	<center>
				<img class="img-responsive thumbnail" src="images/logo.png" alt="IRSS">
			</center>
			<center><h2>BIODATA PELAMAR</h2></center>
                   <p><h4 class="head-text"><?php echo lang('I'); ?> </h4></p>
...
<table>
  <tbody>	  
				  <tr>
					...
					<td rowspan="5">
						<center>
						<img class="img-responsive thumbnail" width="140px" height="140px" src="<?php echo !empty($person['photo']) ? str_replace(base_url(), "", $person['photo']) : 'assets/photo/no_person.jpg'; ?>" alt="<?php echo $person['name'] ?>">
						</center>
					</td>
				  </tr>
				  <tr>
