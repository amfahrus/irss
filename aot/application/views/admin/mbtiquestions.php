...
<div class="mainholder">
	...
	<p class="pagetittle">Myers-Briggs Type Indicators</p>
<!-- Hint section start-->
...
<!-- Hint section end -->
	...
	<a href="<?=base_url();?>administrator/addmbtiquestion"><img src="<?=base_url();?>assets/admin/images/add.png" ></a><br/> Add question </a>
    </p>
	</div>
	<div class="clear"></div>
	...
	<th></th>
		...
		if(isset($questions))
		{
			foreach($questions->result_array() as $row)
			{
				...
				<td style="line-height:5px;text-align:center"><a href='.base_url().'administrator/editmbtiquestion/'.$row['mbti_questionid'].'><img src='.base_url().'assets/admin/images/edit.png></a></td>
				<td style="line-height:5px;text-align:center"><a class="deletebttn" href="#" id='.$row['mbti_questionid'].'><img src='.base_url().'assets/admin/images/delete.png></a></td>
				</tr>';
			}
...
<script type="text/javascript">
	  ...
	  $.ajax({
	  type: "POST",
	  url: "<?=base_url();?>administrator/deletembtiquestion",
	  data: {"mbti_questionId": questionId },
