...
<div class="mainholder">
	...
	<?php 
		...
		<form action="<?php echo base_url().'administrator/adddiscquestion'; ?>" method="post" id="createquestionform">
		<table>
	    <tbody>
	    <tr>
		...
		<td><button type="button" id="btnDel" name="btnDel">remove option</button></td>
	 	...
	 	<tr>
	 	<td>&nbsp;</td>
	 	<td><input type="submit" value="Save Question" name="adddiscquestionbttn" class="input-button ui-corner-all ui-state-default"></td>
	    </tr>
	    </tbody></table>
	    </form>
	</div>
