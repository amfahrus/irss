...
<script>
$(function () {
	var cstate = <?php echo $options->num_rows() > 0 ? $options->num_rows() : 1 ; ?>;
    $('#btnAdd').click(function () {
        ...
        newElem.find('.option_mtype').val([1]);
		
        newElem.find('.option_jtype').val([1]);
...
<div class="mainholder">
	...
	<?php 
		...
		<h2 id="reference" name="reference" class="heading-reference">Option #<?php echo $i; ?></h2> 
		<table>
	    <tbody>
		<tr>
	    ...
	    <td><div class="input">
	    	...
	    	<option value="A" <?php echo $option['option_label'] == 'A' ? 'selected' : ''; ?>> Option A</option>
	    	<option value="B" <?php echo $option['option_label'] == 'B' ? 'selected' : ''; ?>> Option B</option>
	    	<option value="C" <?php echo $option['option_label'] == 'C' ? 'selected' : ''; ?>> Option C</option>
	    	<option value="D" <?php echo $option['option_label'] == 'D' ? 'selected' : ''; ?>> Option D</option>
	    	</select>
	    </div>
	    ...
	    <td><div class="input">
	    	<textarea cols="50" rows="5" name="option_desc[]" class="ui-corner-all input-text validate[required]" style="resize:none"><?php echo $option['option_desc']; ?></textarea></div></td></div></td>
	    </tr>
	    <tr>
	    <td><div class="label">Option Marks</div></td>
	    <td><div class="input">
	    	<input type="text" name="option_marks[]" class="option_marks ui-corner-all input-text validate[required] custom[integer]" value="<?php echo $option['option_marks']; ?>">
	    </div>
		
	    </td>
	    </tr>
		<tr>
	    <td><div class="label">Option Type M</div></td>
	    <td><div class="input">
	    	<select name="option_mtype[]" class="option_mtype input-text validate[required]">
	    	<option value="D" <?php echo $option['option_mtype'] == 'D' ? 'selected' : ''; ?>> D</option>
	    	<option value="I" <?php echo $option['option_mtype'] == 'I' ? 'selected' : ''; ?>> I</option>
	    	<option value="S" <?php echo $option['option_mtype'] == 'S' ? 'selected' : ''; ?>> S</option>
	    	<option value="C" <?php echo $option['option_mtype'] == 'C' ? 'selected' : ''; ?>> C</option>
	    	</select>
	    </div>
		...
		<tr>
	    <td><div class="label">Option Type J</div></td>
	    <td><div class="input">
	    	<select name="option_jtype[]" class="option_jype input-text validate[required]">
	    	<option value="D" <?php echo $option['option_jtype'] == 'D' ? 'selected' : ''; ?>> D</option>
	    	<option value="I" <?php echo $option['option_jtype'] == 'I' ? 'selected' : ''; ?>> I</option>
	    	<option value="S" <?php echo $option['option_jtype'] == 'S' ? 'selected' : ''; ?>> S</option>
	    	<option value="C" <?php echo $option['option_jtype'] == 'C' ? 'selected' : ''; ?>> C</option>
	    	</select>
	    </div>
	    ...
	    <td><div class="label">Option Type J</div></td>
	    <td><div class="input">
	    	<select name="option_jtype[]" class="option_jtype input-text validate[required]">
	    	<option value="D"> D</option>
	    	<option value="I"> I</option>
	    	<option value="S"> S</option>
	    	<option value="C"> C</option>
		...
		<td><button type="button" id="btnDel" name="btnDel">remove option</button></td>
	 	...
	 	<tr>
	 	<td>&nbsp;</td>
	 	<td><input type="submit" value="Save Question" name="edidiscquestionbttn" class="input-button ui-corner-all ui-state-default"></td>
	    </tr>
	    </tbody></table>
	    </form>
	</div>
