                            ...
                            if ($sql->num_rows() > 0) {
                                foreach ($sql->result() as $row) {
									...
									<tr>
                                        ...
                                        <td class="center">
											<a class="btn btn-info" href="<?php echo base_url() . $link_edit . $row->city_id; ?>">
												<i class="icon-edit icon-white"></i>  
												Edit                                            
											</a>
											<a class="btn btn-danger" href="<?php echo base_url() . $link_delete . $row->city_id; ?>" onclick="return confirm(\'Yakin dihapus?\')">
