						...
						<form class="form-horizontal" action="<?php echo base_url() . $act; ?>" accept-charset="utf-8" enctype="multipart/form-data" method='post'>
							<fieldset>
								<div class="control-group">
									<label class="control-label" for="focusedInput">Term Name</label>
									<div class="controls">
									  <input class="input-xlarge focused" name='term_name' id="focusedInput" type="text" value="<?php echo set_value('term_name', isset($data['term_name']) ? $data['term_name'] : ''); ?>">
									</div>
								</div>
