      ...
      <div class="row row-offcanvas row-offcanvas-right">
		...
		<div class="panel panel-default">
			  <div class="panel-heading">
                   <p><h4 class="head-text"><b><?php echo lang('news'); ?> <span class="pull-right"><a class="btn btn-primary" href="<?php echo base_url().'company/add_news/'; ?>"><span class="glyphicon glyphicon-plus"></span> Add</a></span></h4></p>
              </div>
			  <div class="panel-body">
				<table class="table table-striped table-bordered table-hover table-responsive" id="tbl_server" border="0" cellpadding="0" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th width="20%"><?php echo lang('news_name'); ?></th>
