...
disable = function(id){
	var r = confirm("Are you sure to disable this account?");
	if (r == true) {
		$.ajax({
            url: '<?php echo base_url(); ?>master_account/disable/'+id,
            success: function() {
                $('#tbl_server').dataTable().fnStandingRedraw();
            }
        });	
	}
}
...
enable = function(id){
	var r = confirm("Are you sure to enable this account?");
	if (r == true) {
		$.ajax({
            url: '<?php echo base_url(); ?>master_account/enable/'+id,
            success: function() {
                $('#tbl_server').dataTable().fnStandingRedraw();
            }
        });	
