...
<div class="modal-dialog">
        ...
        <h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-th-large"></span> <?php echo lang('change_password'); ?></h4>
      </div>
      <div class="modal-body">
        <form class="form-horizontal" role="form" accept-charset="utf-8" method="post" action="<?php echo $act; ?>">
		  ...
		  <div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="password" name="company_account_password" class="form-control" id="inputPassword3" placeholder="<?php echo lang('new_password'); ?>">
