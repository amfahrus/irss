$(function() {
	var myName = $('#username');
	myName.focus(function() { if ($(this).val() == 'Username ...') {$(this).val('');} });
	myName.blur(function() { if ($(this).val() == '') {$(this).val('Username ...');} });		
	var myEmail = $('#password');
	myEmail.focus(function() { if ($(this).val() == 'Password ...') {$(this).val('');} });
	myEmail.blur(function() { if ($(this).val() == '') {$(this).val('Password ...');} });			
	$('.top').click(function () {
		$('body,html').animate({
			scrollTop: 0
		}, 800);
